...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("ThreeNode_CtoB");
...
main(int argc, char* argv[])
{
    ...
    NodeContainer nodes;	//Creates a network topology with 3 devices.
    nodes.Create(3);
    ...
    /*
     * Setting parameters of the clients sending the packages (In GetAddress) the server IP should be used.
     * And configuration of the sending of packages. 
     */
     ...
     /*
      * Installs the Clients in some of the nodes.
      */
