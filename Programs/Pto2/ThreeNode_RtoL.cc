...
main(int argc, char* argv[])
{
     ...
     */
    ApplicationContainer serverApps = echoServerN1.Install(nodes.Get(0));
     ...
     */
    //The addres should be the server adrress where we will send the package
     UdpEchoClientHelper echoClientN1(interfacesN1.GetAddress(0), 9); //Network 1 comunicate with port 9.
     echoClientN1.SetAttribute("MaxPackets", UintegerValue(10));
     echoClientN1.SetAttribute("Interval", TimeValue(Seconds(0.5)));
     echoClientN1.SetAttribute("PacketSize", UintegerValue(1024));


     UdpEchoClientHelper echoClientN2(interfacesN1.GetAddress(0),9); //Network 2 comunicates with port 9.
     echoClientN2.SetAttribute("MaxPackets", UintegerValue(10));
     echoClientN2.SetAttribute("Interval", TimeValue(Seconds(0.5)));
     echoClientN2.SetAttribute("PacketSize", UintegerValue(1024));

     /*
     ApplicationContainer clientAppsN1 = echoClientN1.Install(nodes.Get(1));
...
*/
     ...
     clientAppsN2.Start(Seconds(2.0));
     clientAppsN2.Stop(Seconds(6.0));
     ...
     anim.SetConstantPosition(nodes.Get(1),45.0,91.0);
     anim.SetConstantPosition(nodes.Get(2),91.0,1.0);
